...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/login/index.vue?vue&type=template&id=60e7d74c&
...
// CONCATENATED MODULE: ./pages/login/index.vue?vue&type=template&id=60e7d74c&
...
const login = data => {
  return request["b" /* request */].post('/api/users/login', data); // return request({
  //   url: '/api/users/login',
  //   method: 'POST',
  //   data
  // })
